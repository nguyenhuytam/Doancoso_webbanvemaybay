...
namespace web_banvemaybay.Areas.Admin.Controllers
{
    public class ChuyenbaysController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IDchuyenbay,Diadiemdi,Diadiemden,Ngaydi,Ngayve,Giatien,IDhang,Thoigiandi")] Chuyenbay chuyenbay)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IDchuyenbay,Diadiemdi,Diadiemden,Ngaydi,Ngayve,Giatien,IDhang,Thoigiandi")] Chuyenbay chuyenbay)
        {
            if (ModelState.IsValid)
            {
